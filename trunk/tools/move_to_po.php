...
if (!is_readable(GLPI_ROOT . "/plugins/timelineticket/locales/" . $_GET['lang'] . ".php")) {
...
$lf = fopen(GLPI_ROOT . "/plugins/timelineticket/locales/" . $_GET['lang'] . ".php", "r");
$lf_new = fopen(GLPI_ROOT . "/plugins/timelineticket/locales/temp.php", "w+");
...
include (GLPI_ROOT . "/plugins/timelineticket/locales/temp.php");

if (!is_readable(GLPI_ROOT . "/plugins/timelineticket/locales/glpi.pot")) {
   print "Unable to read glpi.pot file\n";
   exit();
}
$current_string_plural = '';

$pot = fopen(GLPI_ROOT . "/plugins/timelineticket/locales/glpi.pot", "r");
$po = fopen(GLPI_ROOT . "/plugins/timelineticket/locales/" . $_GET['lang'] . ".po", "w+");
