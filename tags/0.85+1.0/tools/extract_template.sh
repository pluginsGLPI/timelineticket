...
xgettext *.php */*.php */*/*.php --copyright-holder='Timelineticket Development Team' --package-name='GLPI - Timelineticket plugin' --package-version='0.84+1.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
