...
class AssignUser extends CommonDBTM
{
    ...
    * type = new or delete
    */
    public function createUser(Ticket $ticket, $date, $users_id, $type)
    {
    ...
    public function showTimeline(Ticket $ticket, $params = [])
    {
       ...
       /* Define the indicator sections */
        ...
        $a_users_list      = [];
        $IndicatorSections = Tool::getDetails($ticket, 'user');
        ...
        foreach ($IndicatorSections as $users_id => $array) {
            ...
            echo "<img src='" . PLUGIN_TIMELINETICKET_WEBDIR . "/front/graph.send.php?file=" . $filename . ".png'>
<br/>";
            echo "</td>";
            echo "</tr>";
        }
